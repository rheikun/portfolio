...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-green-900 via-emerald-950 to-neutral-950 text-white relative overflow-hidden">
      {/* Background */}
      ...
      <div className="relative z-10 container-custom py-8 flex items-center min-h-[100dvh] lg:min-h-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center w-full">
          ...
          <div className="space-y-4 text-center lg:text-left order-2 lg:order-1 px-2" data-aos="fade-up">
            <div className="inline-flex items-center mt-1 gap-3 px-6 py-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full hover:border-primary-400/30 transition-all duration-300">
            ...
            <div className="text-xl md:text-2xl font-bold text-primary-300 font-mono mt-2">
              <Typewriter
            ...
            {/* Social Icons */}
            <div className="flex justify-center lg:justify-start gap-4 mt-4" data-aos="fade-up" data-aos-delay="500">
          ...
          <div className="flex justify-center lg:justify-end order-1 lg:order-2" data-aos="fade-up" data-aos-delay="300">
            <div className="relative">
              ...
              <div className="relative w-60 h-60 md:w-64 md:h-64 lg:w-72 lg:h-72">
                ...
                <div className="absolute -top-0 -right-6 w-10 h-10 bg-gradient-to-r from-primary-400 to-primary-300 rounded-xl flex items-center justify-center animate-bounce shadow-lg" style={{ animationDelay: '1s' }}>
